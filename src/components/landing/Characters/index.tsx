...
export const Characters = () => {
    ...
    return (
        <div id='Characters' className="container mx-auto">
            <h2 ref={ref} className={`${isVisible ? 'visible animate__animated animate__fadeInUp' : 'invisible'} mb-8 text-3xl md:text-4xl font-[Audiowide] uppercase text-white text-center`}><span className="text-kintsugi-yellow">kintsugi</span> characters</h2>

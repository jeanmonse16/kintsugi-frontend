...
export const About = () => {
    ...
    return (
        <div ref={ref} id='About' className="container mx-auto flex flex-col p-4 md:p-0 items-center text-white text-center">
                <h2 className={`${isVisible ? 'visible animate__animated animate__fadeInUp' : 'invisible'} mb-8 text-3xl md:text-4xl font-[Audiowide] uppercase `}>About <span className="text-kintsugi-yellow">kintsugi</span></h2>
                <article className="flex flex-col md:w-1/2 text-lg gap-4">
                    ...
                    <p className={`${isVisible ? 'visible animate__animated animate__fadeInUp' : 'invisible'} `} style={{ animationDelay: '0.75s'}}>Enjoy the experience <span className="font-[Audiowide] text-kintsugi-yellow">kintsugi</span></p> 
                </article>
        </div>

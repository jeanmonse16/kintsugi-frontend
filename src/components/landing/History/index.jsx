            ...
            <div className='mx-auto text-center text-white'>
                <div className='flex flex-col md:flex-row gap-8 p-4 md:p-0'>
                    <div className='flex flex-col justify-center flex-1 text-center md:order-last'>
                        <h2 className={`${isVisible ? 'visible animate__animated animate__fadeInUp' : 'invisible'} mb-8 text-3xl md:text-4xl font-[Audiowide] uppercase `}><span className="text-kintsugi-yellow">Kinkuni</span> City</h2>

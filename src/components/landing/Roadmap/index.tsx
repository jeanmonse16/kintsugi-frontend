...
export const Roadmap = () => {
    ...
    return (
        <div id='Roadmap' className='container mx-auto'>
            <h2 ref={ref} className={` ${isVisible ? 'visible animate__animated animate__fadeInUp' : 'invisible'} mb-16 text-3xl md:text-4xl font-[Audiowide] text-center text-white uppercase `}><span className="text-kintsugi-yellow">kintsugi</span> Roadmap</h2>
